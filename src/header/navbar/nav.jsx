...
export default function Nav(){
    ...
    return(
        <nav>
            ...
            <ul>
                <li><a href="#" className='hideonmobile'>Brands</a></li>
                <li><a href="#" className='hideonmobile'>About Us</a></li>
                <li><a href="#" className='hideonmobile'>Contact Us</a></li>
                <img src={watchwalalogo} alt="watchwala-logo" className='watchwala-logo'/>
                <li className='login'><a href="#" className='hideonmobile'>Login</a></li>
